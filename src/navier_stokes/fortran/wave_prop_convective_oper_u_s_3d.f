...
c
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine wave_prop_convective_oper_u_s_3d(
     &            q_data, q_gcw,
     ...
     &                (ilower2-u_gcw):(iupper2+u_gcw))
      ...
      real*8 u_data_2((ilower0-u_gcw):(iupper0+u_gcw),
     &                (ilower1-u_gcw):(iupper1+u_gcw),
     ...
     &     inv_dy*(max(u_data_1(i0,i1,i2),0.d0)*
     &     (s_data_1(i1,i2,i0,1)-s_data_1(i1,i2,i0,0))
     &     + min(u_data_1(i0,i1+1,i2),0.d0)*
     &     (s_data_1(i1+1,i2,i0,1)-s_data_1(i1+1,i2,i0,0))
     &     + 0.5d0*(u_data_1(i0,i1+1,i2)+u_data_1(i0,i1,i2))*
     &     (s_data_1(i1+1,i2,i0,0)-s_data_1(i1,i2,i0,1)))

         r_data(i0,i1,i2,j) = r_data(i0,i1,i2,j) +
     &     inv_dz*(max(u_data_2(i0,i1,i2),0.d0)*
     &     (s_data_2(i2,i0,i1,1)-s_data_2(i2,i0,i1,0))
     &     + min(u_data_2(i0,i1,i2+1),0.d0)*
     &     (s_data_2(i2+1,i0,i1,1)-s_data_2(i2+1,i0,i1,0))
     &     + 0.5d0*(u_data_2(i0,i1,i2+1)+u_data_2(i0,i1,i2+1))*
